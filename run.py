...
if os.path.exists(requirements_file):
    ...
    print(f"Nenhum arquivo {requirements_file} encontrado. Instalando 'avabot'...")
    subprocess.run([os.path.join(VENV_DIR, "bin", "pip"), "install", "avabot"])

# Executar o comando dentro do ambiente virtual
print("Executando o comando python -m avabot...")
subprocess.run([os.path.join(VENV_DIR, "bin", "python"), "-m", "avabot"])
